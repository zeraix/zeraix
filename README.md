...
[CHANGELOG](https://github.com/zeraix/zeraix/blob/main/CHANGELOG.md)
...
|---|---|---|
| Stable | v2.3.1 | [macOS](https://github.com/zeraix/zeraix/releases/download/v2.3.1/Zeraix-intl-2.3.1.dmg) · [Windows](https://github.com/zeraix/zeraix/releases/download/v2.3.1/Zeraix-intl-2.3.1.exe) |
